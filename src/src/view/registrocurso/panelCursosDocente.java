...
public class panelCursosDocente extends javax.swing.JPanel {
    ...
    private void btnSeleccionarCursoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSeleccionarCursoActionPerformed
       int filaSeleccionada = TablaCursos.getSelectedRow();
        ...
        String codigoCurso = modelo.getValueAt(filaSeleccionada, 1).toString(); // Suponemos que es "C105"

        // Aquí deberías tener un método para convertir código a ID (puedes mantenerlo simple si ya tienes el ID)
        int cursoID = curso.obtenerCursoIDPorCodigo(codigoCurso); // Reemplaza con lógica real
        ...
        panelEstudiantes.cargarDatos(cursoID, docente.getDocID());
