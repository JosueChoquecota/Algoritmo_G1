...
public class panelCalculoPuntaje extends javax.swing.JPanel {
    ...
    public panelCalculoPuntaje(Docente docente, int cursoID,  JPanel panelDashboard) {
        initComponents();
    ...
    private void llenarTablaPorUnidad(int unidad) {
        ...
        for (PuntajeTotalEstudiante p : lista) {
            modelo.addRow(new Object[]{
                ...
                p.getSemanas(),
                p.getTotalPuntaje(),
                String.format("%.2f", p.getPromedioPorSemana())
            });
        }
    }
    ...
    private void initComponents() {
        ...
        btnUnidad1.setBackground(new java.awt.Color(0, 204, 204));
        ...
        btnUnidad2.setBackground(new java.awt.Color(0, 204, 204));
        ...
        btnUnidad3.setBackground(new java.awt.Color(0, 204, 204));
        ...
        btnUnidad4.setBackground(new java.awt.Color(0, 204, 204));
        ...
        TablaPromedio.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Nombre Completo", "Unidad", "Semanas", "Total Puntaje", "Promedio"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.String.class, java.lang.String.class, java.lang.Object.class, java.lang.Object.class, java.lang.Integer.class, java.lang.Object.class
            };
